...
object Aggregator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = env.readTextFile("file:///home/hadoop/sliding_q8_inc.csv").filter(!_.isEmpty).map(x => {
    ...
    throughput.writeAsCsv("file:///home/hadoop/sliding_q8_inc_throughput.csv").setParallelism(1)
    eventTimeLatency.writeAsCsv("file:///home/hadoop/sliding_q8_inc_event.csv").setParallelism(1)
    processTimeLatency.writeAsCsv("file:///home/hadoop/sliding_q8_inc_process.csv").setParallelism(1)
